...
function Navbar() {
  ...
  return (
    <AppBar position="static" color="common" style={{ boxShadow: "0px 2px 4px -1px rgba(0,0,0,0.06),0px 4px 5px 0px rgba(0,0,0,0.045),0px 1px 10px 0px rgba(0,0,0,0.03)" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box className="ms-4" sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>
            {pages.map((page) => (
              <Button
                key={page}
