...
return (
        <Container
            ...
            className="gap-5 pt-5 min-vh-100 d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-start justify-content-sm-center align-items-sm-center"
        >
            <div className="sidebar pt-5 d-flex flex-column align-items-center gap-5 col-12 col-md-6 col-lg-3">
                ...
                <div
                    style={{ border: 'solid 1px #999', borderRadius: '10px' }}
                    className="controls p-3 d-flex flex-column gap-5 w-100"
                >
                    <div
                        style={{
            ...
            <div className="main pt-5 d-flex flex-column ps-lg-5 ms-5 align-items-start gap-5 w-75">
                {active === 'Info' ? (
                    <Info handleClickOpen={handleClickOpen} />
                ) : active === 'Security' ? (
                    <Security />
                ) : (
                    <Preference />
